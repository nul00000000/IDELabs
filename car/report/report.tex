...
\section{Comparison to Other Works}
    ...
    Vision [2]. Using this algorithm, straight lines on an image can be pinpointed
    ...
    Detection Model, published by John F. Canny in 1986 [3]. This algorithm is
...
\begin{thebibliography}{00}
    ...
    \bibitem{b3} 
    John Francis Canny (1986) \emph{A Computational Approach To Edge Detection} [Online]. Available: https://www.researchgate.net/ \\ publication/224377985\_A\_Computational\_Approach\_To\_Edge\_Detection
    \bibitem{b3} 
    Henil Gajjar, Stavan Sanyal, Manan Shah (2023) \emph{A comprehensive study on lane detecting autonomous car using computer vision} [Online]. Available: https://doi.org/10.1016/j.eswa.2023.120929
    \end{thebibliography}
