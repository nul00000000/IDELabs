...
void ControlPin_SI_Init()
{
	...
	P5->SEL0 &= ~BIT5; // select Port5 Bit5 for use as port I/O
	P5->SEL1 &= ~BIT5; // select Port5 Bit5 for use as port I/O 
	P5->DIR |= BIT5;   // set BIT 5 as output
...
void ControlPin_CLK_Init()
{
	...
	P5->SEL0 &= ~BIT4; // select Port5 Bit5 for use as port I/O
	P5->SEL1 &= ~BIT4; // select Port5 Bit5 for use as port I/O 
	P5->DIR |= BIT4;   // set BIT 4 as output
