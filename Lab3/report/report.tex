...
and a 20k$\Omega$ resistor. The voltage relationships are shown more clearly in Figures \ref{dvcFigure10k} and \ref{dvcFigure20k}.

\begin{figure}[htbp]
    \centerline{\includegraphics{images/dv10k.png}}
    \caption{Voltage vs. Distance with 10k$\Omega$ resistor}
    \label{dvcFigure10k}
\end{figure}

\begin{figure}[htbp]
    \centerline{\includegraphics{images/dv20k.png}}
