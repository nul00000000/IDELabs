...
\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{Images/Part 1 Circuit.png} % The width= allows you to change the image scaling
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{Images/Part 2 Circuit.png} % The width= allows you to change the image scaling
