...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\textwidth]{Images/Part 1 Circuit.png} % The width= allows you to change the image scaling
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\textwidth]{Images/Part 2 Circuit.png} % The width= allows you to change the image scaling
...
%I will finish this when design methodology is done so
%I know what im working with
